...
bestcopro_export_bootstrap("situation_immeuble");
...
$access = bestcopro_export_require_exercise_access($connection, "situation_immeuble", $id_exercice);
...
$logo = getSituationImmeubleImageData(__DIR__ . "/../best_copro_logo.svg");
