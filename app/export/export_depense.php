...
$htmlContent .= "</td>";
$htmlContent .= "<td>";
$htmlContent .= "<strong>Dépenses annuelles</strong>";
$htmlContent .= "</td>";
$htmlContent .= "<td>";
$htmlContent .= "<span>" . $nameExercice . "</span>";
$htmlContent .= "</td>";
$htmlContent .= "</tr>";
$htmlContent .= "</table>";
...
foreach ($rubriques as $rubrique):
    ...
    $htmlContent .= "<tr>";
    $htmlContent .=
        '<td style="border: 1px solid #000; width: 140px;text-align: center;background-color: #c8c8c8;"><strong>' .
        strtoupper($rubrique["libelle"]) .
        "<strong></td>";
    $htmlContent .= '<td style="width: 1px;"></td>';
    $htmlContent .=
        '<td style="border: 1px solid #000; width: 40px;text-align: center;background-color: #c8c8c8;"><strong>' .
        date(
            "m/Y",
            strtotime(
    ...
    foreach ($postes as $poste):
        ...
        $htmlContent .= "<tr>";
        $htmlContent .=
            '<td style="border: 1px solid #000; width: 140px;text-align: center;"><strong>' .
            ucfirst($poste["libelle"]) .
            "<strong></td>";
        $htmlContent .= '<td style="width: 1px;"></td>';
        for ($i = 0; $i < 12; $i++):
            ...
            if (abs(floatval($montantDepenses)) < 0.00001):
                ...
                $htmlContent .=
                    ...
                    number_format($montantDepenses, 2) .
                    "</td>";
            endif;
    ...
    $htmlContent .= "<tr>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;padding: 3px;text-align: center; "><strong>TOTAL</strong></td>';
    $htmlContent .= "<td></td>";
    $htmlContent .=
    ...
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
        number_format($totalDepenses[1], 2) .
        "</strong></td>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
        number_format($totalDepenses[2], 2) .
        "</strong></td>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
        number_format($totalDepenses[3], 2) .
        "</strong></td>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
        number_format($totalDepenses[4], 2) .
        "</strong></td>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
        number_format($totalDepenses[5], 2) .
        "</strong></td>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
        number_format($totalDepenses[6], 2) .
        "</strong></td>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
        number_format($totalDepenses[7], 2) .
        "</strong></td>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
        number_format($totalDepenses[8], 2) .
        "</strong></td>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
        number_format($totalDepenses[9], 2) .
        "</strong></td>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
        number_format($totalDepenses[10], 2) .
        "</strong></td>";
    $htmlContent .=
        '<td style="border: 1px solid #000;background-color: #00B0F0;text-align: center;"><strong>' .
