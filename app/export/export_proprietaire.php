...
$htmlContent .=
    '<div style="font-size: 12px;border: 1px solid #000;text-align: center;padding: 3px;margin-bottom: 10px;">';
...
$htmlContent .= "<tr>";
$htmlContent .=
    '<td style="border: 1px solid #000;width: 120px;text-align: right;padding-right: 10px;background-color: #9cc2e5;">Nom & Prénom</td>';
$htmlContent .=
    '<td style="border: 1px solid #000;padding-left: 15px;font-weight: bold;" colspan="4">' .
...
$htmlContent .= "<tr>";
$htmlContent .=
    '<td style="border: 1px solid #000;width: 120px;text-align: right;padding-right: 10px;background-color: #9cc2e5;">Code ' .
    $typeLot[0]["libelle"] .
    "</td>";
$htmlContent .=
    '<td style="border: 1px solid #000;width: 180px;padding-left: 15px;font-weight: bold;">' .
    $lot[0]["code"] .
    "</td>";
$htmlContent .= '<td style="width: 1px;"></td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 120px;text-align: right;padding-right: 10px;background-color: #9cc2e5;">N° Immeuble</td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 180px;padding-left: 15px;font-weight: bold;">' .
    $lot[0]["numeroImm"] .
    "</td>";
...
$htmlContent .= "<tr>";
$htmlContent .=
    '<td style="border: 1px solid #000;width: 120px;text-align: right;padding-right: 10px;background-color: #9cc2e5;">N° ' .
    $typeLot[0]["libelle"] .
    "</td>";
$htmlContent .=
    '<td style="border: 1px solid #000;width: 180px;padding-left: 15px;font-weight: bold;">' .
...
$htmlContent .= '<td style="width: 1px;"></td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 120px;text-align: right;padding-right: 10px;background-color: #9cc2e5;">N° Titre foncier</td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 180px;padding-left: 15px;font-weight: bold;">';
"</td>";
if ($lot[0]["foncier"] != "") {
    $htmlContent .= $lot[0]["foncier"];
} else {
    $htmlContent .= "N/A";
}
$htmlContent .= "</td>";
...
$htmlContent .= "<tr>";
$htmlContent .=
    '<td style="border: 1px solid #000;width: 120px;text-align: right;padding-right: 10px;background-color: #9cc2e5;">Téléphone</td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 180px;padding-left: 15px;font-weight: bold;">';
if ($proprietaire[0]["telephone"] != "") {
    $htmlContent .= $proprietaire[0]["telephone"];
} else {
    $htmlContent .= "N/A";
}
$htmlContent .= "</td>";
$htmlContent .= '<td style="width: 1px;"></td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 120px;text-align: right;padding-right: 10px;background-color: #9cc2e5;">E-mail</td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 180px;padding-left: 15px;font-weight: bold;">';
if ($proprietaire[0]["email"] != "") {
    $htmlContent .= $proprietaire[0]["email"];
} else {
    $htmlContent .= "N/A";
}
$htmlContent .= "</td>";
...
$htmlContent .= "<tr>";
$htmlContent .=
    '<td style="border: 1px solid #000;width: 120px;text-align: right;padding-right: 10px;background-color: #9cc2e5;">Base des cotisations</td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 180px;padding-left: 15px;font-weight: bold;">' .
    number_format(floatval($info[0]["sumPartFonctPartInv"]), 2) .
    "</td>";
$htmlContent .= '<td style="width: 1px;"></td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 120px;text-align: right;padding-right: 10px;background-color: #9cc2e5;">Tantième</td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 180px;padding-left: 15px;font-weight: bold;">' .
    floatval($lot[0]["tantieme"]) .
    "</td>";
$htmlContent .= "</tr>";
$htmlContent .= "</table>";
...
$htmlContent .= "<tr>";
$htmlContent .=
    '<td style="border: 1px solid #000;text-align: center;background-color: #92d050;font-weight: bold;" colspan="4">Tableau des encaissements</td>';
$htmlContent .= "</tr>";
$htmlContent .= '<tr><td colspan="4"></td></tr>';
$htmlContent .= "<tr>";
$htmlContent .=
    '<td style="border: 1px solid #000;width: 25%;text-align: center;background-color: #c9c9c9;">Date de paiement</td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 25%;text-align: center;background-color: #c9c9c9;">Mode de paiement</td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 25%;text-align: center;background-color: #c9c9c9;">N° du reçu</td>';
$htmlContent .=
    '<td style="border: 1px solid #000;width: 25%;text-align: center;background-color: #c9c9c9;">Montant en MAD</td>';
$htmlContent .= "</tr>";
