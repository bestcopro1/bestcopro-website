			...
			$.ajax({
				...
				error:function(xhr) {
					...
					if (xhr.status === 413) {
						...
						message = "Le serveur n'a pas pu enregistrer le document (HTTP 500). Vérifiez que le dossier justificatifs/documents existe et qu'il est accessible en écriture.";
