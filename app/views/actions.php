...
if (
    ...
    $dateFinReelle = filter_input(
        INPUT_POST,
        "dateFinReelle",
        FILTER_SANITIZE_STRING,
    );
    $efficacite = filter_input(
        INPUT_POST,
        "efficacite",
        FILTER_SANITIZE_STRING,
    );
    $pilote = filter_input(INPUT_POST, "pilote", FILTER_SANITIZE_STRING);
    $intervenants = filter_input(
        INPUT_POST,
        "intervenants",
        FILTER_SANITIZE_STRING,
    );
    $avancement = filter_input(
        INPUT_POST,
        "avancement",
        FILTER_SANITIZE_STRING,
    );
    $observation = filter_input(
        INPUT_POST,
        "observation",
        FILTER_SANITIZE_STRING,
    );
    ...
    if (empty($error_msg) && isset($_POST["id"], $_POST["update"])) {
        ...
        if ($id != "" && $update == "true") {
            $request =
                "UPDATE action SET nom=?, origine=?, dateDebut=?, dateFin=?, dateFinReelle=?, id_statutAction=?, efficacite=?, pilote=?, intervenants=?, avancement=?, observation=? WHERE id=?";
			...
			<div class="container-fluid">
                ...
                <div class="row">
                 ...
                 "id_copropriete"
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="nom" placeholder="Nom de l'action" value="<?= $planAction[0][
                 "nom"
             ] ?>">
												</div>
											</div>
                                            <div class="col-4 mb-2">
											    <div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="origine" placeholder="Origine" value="<?= $planAction[0][
                 "origine"
             ] ?>">
												</div>
											</div>
											<div class="col-4 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_statutAction" class="default-select form-control input-rounded wide mb-3">
                                                        ...
                                                        <option value="<?= $statutaction[
                                                            "id"
                                                        ] ?>" <?php if (
    $statutaction["id"] == $planAction[0]["id_statutAction"]
) {
    echo "selected";
} ?>><?= $statutaction["libelle"] ?></option>
                                                        <?php endforeach;
                                                        ?>
                                                    </select>
                                                </div>
											...
											<div class="col-4 mb-2">
											    <div class="form-group">
													...
													<input type="date" class="form-control input-rounded input-default mb-3" name="dateDebut" placeholder="jj/mm/aaaa" value="<?= $planAction[0][
                 "dateDebut"
             ] ?>">
												</div>
											</div>
											<div class="col-4 mb-2">
											    <div class="form-group">
													...
													<input type="date" class="form-control input-rounded input-default mb-3" name="dateFin" placeholder="jj/mm/aaaa" value="<?= $planAction[0][
                 "dateFin"
             ] ?>">
												</div>
											</div>
                                            <div class="col-4 mb-2">
											    <div class="form-group">
													...
													<input type="date" class="form-control input-rounded input-default mb-3" name="dateFinReelle" placeholder="jj/mm/aaaa" value="<?= $planAction[0][
                 "dateFinReelle"
             ] ?>">
												</div>
											</div>
											...
											<div class="col-4 mb-2">
											    <div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="pilote" placeholder="Pilote" value="<?= $planAction[0][
                 "pilote"
             ] ?>">
												</div>
											</div>
											<div class="col-4 mb-2">
											    <div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="intervenants" placeholder="Intervenants" value="<?= $planAction[0][
                 "intervenants"
             ] ?>">
												</div>
											</div>
											<div class="col-12 mb-4">
											    <div class="form-group">
													...
													<input type="hidden" id="avancement" name="avancement" placeholder="Avancement" value="<?= $planAction[0][
                 "avancement"
             ] ?>">
                                            ...
                                            <div class="col-12 mb-2">
											    <div class="form-group">
													...
													<textarea class="form-control input-rounded input-default mb-3" name="observation" placeholder="Observation"><?= $planAction[0][
                 "observation"
             ] ?></textarea>
												</div>
											</div>
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <?php foreach (
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="./dashboard.php?page=actions&action=update&id=<?= $planAction[
                                                    "id"
