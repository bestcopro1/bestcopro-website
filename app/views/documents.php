...
if (isset($_GET["action"], $_GET["id"])):
    ...
    if ($action == "update" && $id != ""):
        ...
        $preuves = bestcoproDocumentFiles($document[0]["id"]);
        ?>
    ...
    echo "selected";
                 ...
                 ?>
											...
											<div class="col-6 mb-2" >
                                                <div class="form-group">
													<label class="text-label">Remplacer le document (optionnel)</label>
													...
													<div class="alert alert-success mt-2 mb-0 py-2">
														Fichier actuellement li&eacute; :
														<a href="<?= htmlspecialchars(bestcoproDocumentPublicUrl($preuves[0]), ENT_QUOTES, "UTF-8") ?>" target="_blank" rel="noopener" class="alert-link">
															<?= htmlspecialchars(basename($preuves[0]), ENT_QUOTES, "UTF-8") ?> &mdash; Ouvrir
														</a>
													</div>
													<?php else: ?>
													<div class="alert alert-warning mt-2 mb-0 py-2">
														Aucune pi&egrave;ce jointe trouv&eacute;e pour le document ID #<?= (int) $document[0]["id"] ?>.
													</div>
													<?php endif; ?>
												</div>
											</div>
