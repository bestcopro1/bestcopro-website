...
if (
    ...
    if (empty($error_msg) && isset($_POST["id"], $_POST["update"])) {
        ...
        if ($id != "" && $update == "true") {
            $request =
                "UPDATE proprietaire SET civilite=?, prenom=?, nom=?, email=?, telephone=?, mobile=?, adresse=?, ville=?, codePostale=? WHERE id=?";
                                        ...
                                        <div class="row">
											...
											<div class="col-5  mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="prenom" placeholder="Prénom" value="<?= $proprietaire[0][
                 "prenom"
             ] ?>">
												</div>
											</div>
                                            <div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="nom" placeholder="Nom" value="<?= $proprietaire[0][
                 "nom"
             ] ?>">
												</div>
											</div>
											<div class="col-12 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="email" placeholder="Email" value="<?= $proprietaire[0][
                 "email"
             ] ?>">
												</div>
											</div>
											<div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="telephone" placeholder="Téléphone" value="<?= $proprietaire[0][
                 "telephone"
             ] ?>">
												</div>
											</div>
                                            <div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="mobile" placeholder="Mobile" value="<?= $proprietaire[0][
                 "mobile"
             ] ?>">
												</div>
											</div>
											<div class="col-12 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="adresse" placeholder="Adresse" value="<?= $proprietaire[0][
                 "adresse"
             ] ?>">
												</div>
											</div>
											<div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="ville" placeholder="Ville" value="<?= $proprietaire[0][
                 "ville"
             ] ?>">
												</div>
											</div>
											<div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="codePostale" placeholder="Code postal" value="<?= $proprietaire[0][
                 "codePostale"
             ] ?>">
												</div>
											</div>
...
<?php else:goto iomEnd;endif;
    ...
    ?>
     ...
     "prenom"
												...
												<td class="text-center"><a href="./dashboard.php?page=proprietaires&action=update&id=<?= $proprietaire[
                "id"
