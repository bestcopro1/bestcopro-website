...
if (
    ...
    if (empty($error_msg) && isset($_POST["id"], $_POST["update"])) {
        ...
        if ($id != "" && $update == "true") {
            $request =
                "UPDATE fournisseur SET raisonSocial=?, ice=?, email=?, telephone=?, adresse=?, ville=?, codePostale=? WHERE id=?";
                                        ...
                                        <div class="row">
											<div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="raisonSocial" placeholder="Raison sociale" value="<?= $fournisseur[0][
                 "raisonSocial"
             ] ?>">
												</div>
											</div>
											<div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="ice" placeholder="ICE" value="<?= $fournisseur[0][
                 "ice"
             ] ?>">
												</div>
											</div>
											<div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="email" placeholder="Email" value="<?= $fournisseur[0][
                 "email"
             ] ?>">
												</div>
											</div>
											<div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="telephone" placeholder="Téléphone" value="<?= $fournisseur[0][
                 "telephone"
             ] ?>">
												</div>
											</div>
											<div class="col-12 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="adresse" placeholder="Adresse" value="<?= $fournisseur[0][
                 "adresse"
             ] ?>">
												</div>
											</div>
											<div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="ville" placeholder="Ville" value="<?= $fournisseur[0][
                 "ville"
             ] ?>">
												</div>
											</div>
                                            <div class="col-6 mb-2">
												<div class="form-group">
													...
													<input type="text" class="form-control input-rounded input-default mb-3" name="codePostale" placeholder="Code postal" value="<?= $fournisseur[0][
                 "codePostale"
             ] ?>">
												</div>
											</div>
                                    ...
                                    <table id="example" class="display" style="min-width: 845px">
                                        ...
                                        <?php foreach (
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="./dashboard.php?page=fournisseurs&action=update&id=<?= $fournisseur[
                                                    "id"
