...
class Options
{
    ...
    public function set($attributes, $value = null)
    {
        ...
        foreach ($attributes as $key => $value) {
            if ($key === "tempDir" || $key === "temp_dir") {
                ...
                $key === "defaultPaperOrientation" ||
                $key === "default_paper_orientation"
            ) {
     ...
     * @return $this
     */
    public function setDefaultPaperOrientation(
        string $defaultPaperOrientation,
    ): self {
    ...
    {
        $this->httpContext = is_array($httpContext)
