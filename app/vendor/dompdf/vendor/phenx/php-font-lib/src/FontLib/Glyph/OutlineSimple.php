...
class OutlineSimple extends Outline
{
    ...
    public function encodePoints($points)
    {
        ...
        // Simple glyf
        $l += $font->w(
            [self::uint16, count($endPtsOfContours)],
            $endPtsOfContours,
        ); // endPtsOfContours
            ...
            if ($point["onCurve"]) {
                if ($point_p1["onCurve"]) {
                    ...
                    if ($point_p2["onCurve"]) {
                        ...
                        $path .=
                            "Q{$point_p1["x"]},{$point_p1["y"]}," .
                            $this->midValue($point_p1["x"], $point_p2["x"]) .
                            "," .
                            $this->midValue($point_p1["y"], $point_p2["y"]) .
                            " ";
                    }
                ...
                if ($point_p1["onCurve"]) {
                    ...
                    $path .=
                        "Q{$point["x"]},{$point["y"]}," .
                        $this->midValue($point["x"], $point_p1["x"]) .
                        "," .
                        $this->midValue($point["y"], $point_p1["y"]) .
                        " ";
                }
